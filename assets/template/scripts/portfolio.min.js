...
"use strict";var App={options:{},init:function(){this.animation()},modal:function(){var t,o=function(t){var o=document.querySelector("body"),n=window.innerWidth-o.clientWidth;$("body").css("padding-right",n+"px"),$("body").addClass("modal-open"),$(".modal-back").show(),t.show().css({opacity:0,top:"-100px"}).animate({opacity:"1",top:"0px"},500)},n=function(t){t.css({opacity:1}).animate({opacity:0},300),$("body").removeClass("modal-open"),$(".modal-back").hide(),$("body").css("padding-right","0px")};$("[data-toggle='modal']").on("click",function(){var a=$(this).attr("data-name");t=$(".modal-content div[data-name='"+a+"']"),o(t),$(document).mouseup(function(o){$("body").hasClass("modal-open")&&(o.preventDefault(),t.is(o.target)||0!==t.has(o.target).length||n(t))})})},animation:function(){function t(t){var o=$(t),n=$(window),a=n.scrollTop(),i=o.offset().top;return $(window).width()>="1200"?i+=100:$(window).width()>="900"?i+=70:i+=10,i<=a+n.height()}function o(o){for(var n=0;n<o.length;n++)!$(o[n]).hasClass(".animate-bottom")&&t(o[n])&&$(o[n]).addClass("animate-bottom")}$(window).width()>="500"&&$(function(){var t=$(".works__item");o(t),$(window).scroll(function(){o(t)})})}};$(document).ready(function(){App.init()});